...
//     model.add(tf.layers.conv2d({inputShape: [28, 28, 1], kernelSize: 3, filters: 20, activation: 'relu'}));
...
//     model.compile({optimizer: tf.train.adam(0.06), loss: 'categoricalCrossentropy', metrics: ['accuracy']});
//     return model;
// }
